...
**segformer_b3_config/**: (Generated by save_model.py) Local directory containing model configuration. Note: This folder is excluded from Git via .gitignore due to file size, but is required for internet-free execution on Snellius.
